"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_views_components_Calendario_vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/views/components/Calendario.vue?vue&type=script&lang=js":
/*!**********************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/views/components/Calendario.vue?vue&type=script&lang=js ***!
  \**********************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    ...
    return {
      header: {
        headers: {
          Authorization: "Bearer ".concat(token) // Cabecera para todos los metodo de axio
        }
      },
  ...
  methods: {
    mostrarProyectos: function mostrarProyectos() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var eventos, ruta, header, proyectos;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              proyectos = [];
              _context.next = 6;
              return _this2.$store.dispatch('auth/traerDatosTabla', {
                ruta: ruta,
                header: header
            ...
            case 6:
              proyectos.map(function (proyecto) {
                ...
                if (proyecto.estado === 'En progreso' || proyecto.estado === 'En revisión' || proyecto.estado === 'Aplazada') {
                  proyecto.tareas.map(function (tarea) {
              ...
              return _context.abrupt("return", eventos);
            case 8:
            case "end":
    ...
    mostrarComentarios: function mostrarComentarios(id, descripcion) {
      var _this3 = this;
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        var eventos, ruta, header, comentarios, htmlTarea;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              comentarios = [];
              htmlTarea = '<div class="body-chat">';
              _context2.next = 7;
              return _this3.$store.dispatch('auth/traerDatosTabla', {
                ruta: ruta,
                header: header
              }).then(function (result) {
            ...
            case 7:
              comentarios.map(function (comentario) {
                var date = new Date(comentario.created_at);
                var year = date.getFullYear();
                var month = String(date.getMonth() + 1).padStart(2, '0');
                var day = String(date.getDate()).padStart(2, '0');
                var hours = String(date.getHours()).padStart(2, '0');
                var minutes = String(date.getMinutes()).padStart(2, '0');
                var formattedDateTime = "".concat(year, "-").concat(month, "-").concat(day, " ").concat(hours, ":").concat(minutes);
                htmlTarea += "<div class=\"container-chat\">\n                                <label for=\"\">".concat(comentario.email, "</label>\n                                <br>\n                                <p>").concat(comentario.contenido, "</p>\n                                <span class=\"time-right\">").concat(formattedDateTime, "</span>\n                            </div>\n                                ");
              });
              htmlTarea += "</div>";
              _context2.next = 11;
    ...
    showAlertEventoTarea: function showAlertEventoTarea(arg) {
      var _this4 = this;
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        var comparacion, title, evento, htmlTarea, htmlProyecto;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              comparacion = arg.event.extendedProps.tipo === 'proyecto';
              title = comparacion ? 'Proyecto: ' + arg.event.extendedProps.evento.nombre : 'Tarea: ' + arg.event.extendedProps.evento.descripcion;
              evento = arg.event.extendedProps.evento;
              htmlTarea = "<div class=\"container-fluid\">\n                                    <div class=\"row\">\n                                        <div class=\"col\" style='text-align: left;'>\n                                            <div class=\"input-group\">\n                                                <div class=\"input-group-prepend\">\n                                                    <span class=\"input-group-text\" id=\"inputGroupPrepend2\">Descripci\xF3n</span>\n                                                </div>\n                                                <textarea name=\"descripcion\" id=\"descripcion\" readonly class=\"contact-message form-control\">".concat(evento.descripcion, "</textarea>\n                                            </div>\n                                        </div>\n                                    </div>\n                                    <br>\n                                    <div class=\"row\">\n                                        <div class=\"col\" style='text-align: left;'>\n                                            <div class=\"input-group\">\n                                                <div class=\"input-group-prepend\">\n                                                    <span class=\"input-group-text\" id=\"inputGroupPrepend2\">Responsable</span>\n                                                </div>\n                                                <input type=\"text\" value=\"").concat(evento.name, "\" readonly class=\"contact-email form-control\" >\n                                            </div>\n                                        </div>\n                                        <div class=\"col\" style='text-align: left;'>\n                                            <div class=\"input-group\">\n                                                <div class=\"input-group-prepend\">\n                                                    <span class=\"input-group-text\" id=\"inputGroupPrepend2\">Prioridad</span>\n                                                </div>\n                                                <input type=\"text\" value=\"").concat(evento.prioridad, "\" readonly class=\"contact-email form-control\" >\n                                            </div>\n                                        </div>\n                                    </div>\n                                    <br>\n                                    <div class=\"row\">\n                                        <div class=\"col\" style='text-align: left;'>\n                                            <div class=\"input-group\">\n                                                <div class=\"input-group-prepend\">\n                                                    <span class=\"input-group-text\" id=\"inputGroupPrepend2\">Estado</span>\n                                                </div>\n                                                <select class=\"form-control\" name=\"estado\" id=\"estado\">\n                                                    <option ").concat(evento.estado === 'Pendiente' ? 'selected' : '', " value=\"Pendiente\">Pendiente</option>\n                                                    <option ").concat(evento.estado === 'En progreso' ? 'selected' : '', " value=\"En progreso\">En progreso</option>\n                                                    <option ").concat(evento.estado === 'Completada' ? 'selected' : '', " value=\"Completada\">Completada</option>\n                                                    <option ").concat(evento.estado === 'En revisión' ? 'selected' : '', " value=\"En revisi\xF3n\">En revisi\xF3n</option>\n                                                    <option ").concat(evento.estado === 'Aplazada' ? 'selected' : '', " value=\"Aplazada\">Aplazada</option>\n                                                    <option ").concat(evento.estado === 'Bloqueada' ? 'selected' : '', " value=\"Bloqueada\">Bloqueada</option>\n                                                    <option ").concat(evento.estado === 'Cancelada' ? 'selected' : '', " value=\"Cancelada\">Cancelada</option>\n                                                    <option ").concat(evento.estado === 'Rechazada' ? 'selected' : '', " value=\"Rechazada\">Rechazada</option>\n                                                </select>\n                                            </div>\n                                        </div>\n                                        <div class=\"col\" style='text-align: left;'>\n                                            <div class=\"input-group\">\n                                                <div class=\"input-group-prepend\">\n                                                    <span class=\"input-group-text\" id=\"inputGroupPrepend2\">Fecha Limite</span>\n                                                </div>\n                                                <input type=\"date\" value=\"").concat(evento.fecha_limite, "\" readonly class=\"contact-email form-control\" >\n                                            </div>\n                                        </div>\n                                    </div>\n                                    <br>\n                                    <div class=\"row\">\n                                        <div class=\"col-2\"></div>\n                                        <div class=\"col-8\" style='text-align: left;'>\n                                            <div class=\"input-group\">\n                                                    <div class=\"input-group-prepend\">\n                                                        <span class=\"input-group-text\" id=\"inputGroupPrepend2\">Comentar</span>\n                                                    </div>\n                                                    <textarea name=\"comentario\" id=\"comentario\" class=\"contact-message form-control\"></textarea>\n                                            </div>\n                                        </div>\n                                        <div class=\"col-2\"></div>\n                                    </div>\n                                </div>");
              htmlProyecto = "<div class=\"container-fluid\">\n                                <div class=\"row\">\n                                    <div class=\"col\" style='text-align: left;'>\n                                        <div class=\"input-group\">\n                                            <div class=\"input-group-prepend\">\n                                                <span class=\"input-group-text\" id=\"inputGroupPrepend2\">Fecha Inicio</span>\n                                            </div>\n                                            <input type=\"date\" readonly value=\"".concat(evento.fecha_incial, "\" class=\"contact-email form-control\">\n                                        </div>\n                                    </div>\n                                    <div class=\"col\" style='text-align: left;'>\n                                        <div class=\"input-group\">\n                                            <div class=\"input-group-prepend\">\n                                                <span class=\"input-group-text\" id=\"inputGroupPrepend2\">Fecha Final</span>\n                                            </div>\n                                            <input type=\"date\" readonly value=\"").concat(evento.fecha_final, "\" class=\"contact-email form-control\">\n                                        </div>\n                                    </div>\n                                </div>\n                                <br>\n                                <div class=\"row\">\n                                    <div class=\"col-2\"></div>\n                                    <div class=\"col-8\" style='text-align: left;'>\n                                            <div class=\"input-group\">\n                                                <div class=\"input-group-prepend\">\n                                                    <span class=\"input-group-text\" id=\"inputGroupPrepend2\">Estado</span>\n                                                </div>\n                                                <select class=\"form-control\" name=\"estado\" id=\"estado\">\n                                                    <option ").concat(evento.estado === 'Pendiente' ? 'selected' : '', " value=\"Pendiente\">Pendiente</option>\n                                                    <option ").concat(evento.estado === 'En progreso' ? 'selected' : '', " value=\"En progreso\">En progreso</option>\n                                                    <option ").concat(evento.estado === 'Completada' ? 'selected' : '', " value=\"Completada\">Completada</option>\n                                                    <option ").concat(evento.estado === 'En revisión' ? 'selected' : '', " value=\"En revisi\xF3n\">En revisi\xF3n</option>\n                                                    <option ").concat(evento.estado === 'Aplazada' ? 'selected' : '', " value=\"Aplazada\">Aplazada</option>\n                                                    <option ").concat(evento.estado === 'Bloqueada' ? 'selected' : '', " value=\"Bloqueada\">Bloqueada</option>\n                                                    <option ").concat(evento.estado === 'Cancelada' ? 'selected' : '', " value=\"Cancelada\">Cancelada</option>\n                                                    <option ").concat(evento.estado === 'Rechazada' ? 'selected' : '', " value=\"Rechazada\">Rechazada</option>\n                                                </select>\n                                            </div>\n                                    </div>\n                                    <div class=\"col-2\"></div>\n                                </div>\n                            </div>");
              _context3.next = 7;
              return _this4.$swal.fire({
                ...
                preConfirm: function preConfirm() {
                  ...
                  var ruta = '/api/estado';
                  _this4.$store.dispatch('auth/actualizarEstado', {
                    ruta: ruta,
                    data: data,
                    header: header
                  }).then(function (result) {
                ...
                if (result.dismiss === 'cancel') {
                  _this4.mostrarComentarios(evento.id, evento.descripcion);
                }
              });
            case 7:
            case "end":
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/views/components/Calendario.vue?vue&type=template&id=7d278fae":
/*!**************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/views/components/Calendario.vue?vue&type=template&id=7d278fae ***!
  \**************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_2, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_FullCalendar, {
...
/***/ "./resources/js/views/components/Calendario.vue":
/*!******************************************************!*\
  !*** ./resources/js/views/components/Calendario.vue ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _Calendario_vue_vue_type_template_id_7d278fae__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Calendario.vue?vue&type=template&id=7d278fae */ "./resources/js/views/components/Calendario.vue?vue&type=template&id=7d278fae");
/* harmony import */ var _Calendario_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Calendario.vue?vue&type=script&lang=js */ "./resources/js/views/components/Calendario.vue?vue&type=script&lang=js");
...
;
const __exports__ = /*#__PURE__*/(0,C_laragon_www_tech_interview_main_tech_interview_main_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__["default"])(_Calendario_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_Calendario_vue_vue_type_template_id_7d278fae__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/views/components/Calendario.vue"]])
/* hot reload */
if (false) {}
...
/***/ "./resources/js/views/components/Calendario.vue?vue&type=script&lang=js":
/*!******************************************************************************!*\
  !*** ./resources/js/views/components/Calendario.vue?vue&type=script&lang=js ***!
  \******************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_Calendario_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__["default"])
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_Calendario_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./Calendario.vue?vue&type=script&lang=js */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/views/components/Calendario.vue?vue&type=script&lang=js");
 

/***/ }),

/***/ "./resources/js/views/components/Calendario.vue?vue&type=template&id=7d278fae":
/*!************************************************************************************!*\
  !*** ./resources/js/views/components/Calendario.vue?vue&type=template&id=7d278fae ***!
  \************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_dist_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_Calendario_vue_vue_type_template_id_7d278fae__WEBPACK_IMPORTED_MODULE_0__.render)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_dist_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_Calendario_vue_vue_type_template_id_7d278fae__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!../../../../node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./Calendario.vue?vue&type=template&id=7d278fae */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/views/components/Calendario.vue?vue&type=template&id=7d278fae");
